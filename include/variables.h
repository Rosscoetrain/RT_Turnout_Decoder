...
CVPair FactoryDefaultCVs [] =
{
  ...
  {CV_USER_GROUP, DEFAULT_PULSE},
  {CV_USER_GROUP + 1, ACTIVE_OUTPUT_STATE},
  {CV_USER_GROUP + 2, DEFAULT_PULSE},
  {CV_USER_GROUP + 3, ACTIVE_OUTPUT_STATE},
  {CV_USER_GROUP + 4, DEFAULT_PULSE},
  {CV_USER_GROUP + 5, ACTIVE_OUTPUT_STATE},
  {CV_USER_GROUP + 6, DEFAULT_PULSE},
  {CV_USER_GROUP + 7, ACTIVE_OUTPUT_STATE},
  {CV_USER_GROUP + 8, DEFAULT_PULSE},
  {CV_USER_GROUP + 9, ACTIVE_OUTPUT_STATE},
  {CV_USER_GROUP + 10, DEFAULT_PULSE},
  {CV_USER_GROUP + 11, ACTIVE_OUTPUT_STATE},
  {CV_USER_GROUP + 12, DEFAULT_PULSE},
  {CV_USER_GROUP + 13, ACTIVE_OUTPUT_STATE},
  {CV_USER_GROUP + 14, DEFAULT_PULSE},
  {CV_USER_GROUP + 15, ACTIVE_OUTPUT_STATE},
#endif
